...
class Message {
  ...
  async reply(msg) {
    await client.sendMessage(this.jid, msg);
  }
  ...
  async send(content, options = {}) {
    switch (options.type) {
        case 'photo':
            await client.sendPhoto(this.jid, content, options);
            break;
        case 'video':
            await client.sendVideo(this.jid, content, options);
            break;
        case 'audio':
            await client.sendAudio(this.jid, content, options);
            break;
        case 'animation':
            await client.sendAnimation(this.jid, content, options);
            break;
        default:
            await client.sendMessage(this.jid, content, options);
            break;
    }
  }
}
