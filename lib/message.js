...
class Message {
  constructor(client, message, prefix) {
    ...
    this.message.type = types.find(t => this.msg && this.msg[t]);
    ...
    this.quoted = this.msg.reply_to_message ? {
      msg: this.msg.reply_to_message,
      text: this.msg.reply_to_message.text,
      type: types.find(t => this.msg.reply_to_message[t]) || null,
      message: {
          id: this.msg.reply_to_message.message_id,
          type: types.find(t => this.msg.reply_to_message[t]) || null
      }
    } : !!this.msg.reply_to_message;
