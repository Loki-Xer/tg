...
class Message {
  constructor(client, message, prefix) {
    ...
    this.message.type = [this.msg]types.find(t => this.msg && this.msg[t]) || [this.msg]"text";
    ...
    if (this.msg.reply_to_message) {
      ...
      this.quoted.message.type = this.quoted.msg + types.find(t => this.quoted.msg && this.quoted.msg[t]) || [this.msg]"text";
