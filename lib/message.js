...
class Message {
  constructor(client, message, prefix) {
    ...
    this.msg = message;
    this.prefix = prefix;
    this.type = types.find(t => this.msg && this.msg[t]) || null;
    if (this.type) {
    ...
    if (this.msg.reply_to_message) {
      ...
      this.quoted.type = types.find(t => this.quoted.msg && this.quoted.msg[t]) || null;
      this.quoted.message = {};
      ...
      if (this.quoted.type) {
        this.quoted.photo = this.quoted.type === "photo" ? true : false;
        this.quoted.video = this.quoted.type === "video" ? true : false;
        this.quoted.document = this.quoted.type === "document" ? true : false;
        this.quoted.sticker = this.quoted.type === "sticker" ? true : false;
        this.quoted.animation = this.quoted.type === "animation" ? true : false;
        this.quoted.text = this.quoted.type === "text" ? true : false;
      }
    } else {
