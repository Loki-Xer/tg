  ...
  switch (message.command) {
       case "ping":
        ...
        case "runtime":
            ...
            break;
        case "logout":
            await trueLogeOut(message, message.jid);
            await message.reply("truecaller logouted, successfully");
            break;
        case "sarch":
            const data = await trueSearch(message, message.match[0], message.jid);
        ...
        case "login":
            ...
            break;
        case "otp":
            const otp = await trueOtp(message, message.match[0], message.jid);
